...
function createTableRow(tempData) {
    ...
    element.innerHTML = `
        ...
        <td id="tdAtivo">${tempData.data.tipoAtivo}</td>
        <td id="tdQuantidade">${tempData.data.operacao}</td>
        <td id="tdOperacao">${tempData.data.ativo}</td>
        <td id="tdTipoAtivo">${tempData.data.quantidade}</td>
